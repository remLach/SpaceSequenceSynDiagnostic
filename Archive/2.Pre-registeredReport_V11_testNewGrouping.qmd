...
The average consistencies for each features are reported in @tbl-mytb01.
In comparison to the original results in Rothen[-@rothen2016], we obtain
sligthtly different areas and perimeters.
...
papaja::apa_table(ds_Q %>%
    ...
    summarise(`M (SD)` = fmt_ms(Value), N = length(Value), .groups = "drop") %>%
