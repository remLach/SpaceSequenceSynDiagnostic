...
```{r}
knitr::kable(Comp_ROC(ds_Q, "group", "SD_ID_xsc","ID","moreSyn")$Coningency_table)
All_ROC <- rbind(All_ROC,Comp_ROC(ds_Q, "group", "SD_ID_xsc","ID","moreSyn")$ROC_properties)

# INITIALIZE ROC_curves
ROC_curves <- list(Comp_ROC(ds_Q, "group", "SD_ID_xsc","ID","moreSyn")$ROC_curve,Comp_ROC(ds_Q, "group", "SD_ID_xsc","ID","moreSyn")$ROC_properties$Feature)
```

### ROC SD_ID_ysc

```{r}
knitr::kable(Comp_ROC(ds_Q, "group", "SD_ID_ysc","ID","moreSyn")$Coningency_table)
All_ROC <- rbind(All_ROC,Comp_ROC(ds_Q, "group", "SD_ID_ysc","ID","moreSyn")$ROC_properties)

ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "SD_ID_ysc","ID","moreSyn")$ROC_curve,Comp_ROC(ds_Q, "group", "SD_ID_ysc","ID","moreSyn")$ROC_properties$Feature))
```
...
knitr::kable(Comp_ROC(ds_Q, "group", "Consistency","ID","moreCtl")$Coningency_table)
All_ROC <- rbind(All_ROC,Comp_ROC(ds_Q, "group", "Consistency","ID","moreCtl")$ROC_properties)

ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "Consistency","ID","moreCtl")$ROC_curve,Comp_ROC(ds_Q, "group", "Consistency","ID","moreCtl")$ROC_properties$Feature))
```

#### ROC triangle Area zs

```{r, AreaConsistencyzsROC}
knitr::kable(Comp_ROC(ds_Q, "group", "Consistency_zs","ID","moreCtl")$Coningency_table)
All_ROC <- rbind(All_ROC,Comp_ROC(ds_Q, "group", "Consistency_zs","ID","moreCtl")$ROC_properties)
  
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "Consistency_zs","ID","moreCtl")$ROC_curve,Comp_ROC(ds_Q, "group", "Consistency_zs","ID","moreCtl")$ROC_properties$Feature))
```
...
ds %>%
    ...
    arrange(ordered(stimulus, levels = c("Monday", "Tuesday", "Wednesday", "Thursday", "Friday","Saturday","Sunday"))) %>% 
    arrange(ordered(stimulus, levels = c("January", "February", "March", "April", "May","June","July","August","September","October","November","December"))) %>%
    ggplot(aes(x = x, y = y, group = stimulus, label = round(SelfInter_persegm,1), fill = stimulus)) +
    geom_path(aes(x = x, y = y, group = repetition), alpha = 0.2) +
...
ds_Q %>%
  # filter(!isSame_xy) %>%
  Comp_ROC(., "group", "SelfInter_persegm","ID","moreCtl")
All_ROC <- rbind(All_ROC,Comp_ROC(ds_Q, "group", "SelfInter_persegm","ID","moreCtl")$ROC_properties)

  
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "SelfInter_persegm","ID","moreCtl")$ROC_curve,Comp_ROC(ds_Q, "group", "SelfInter_persegm","ID","moreCtl")$ROC_properties$Feature))
```
...
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "GA_segm_leng","ID","moreCtl")$ROC_curve,Comp_ROC(ds_Q, "group", "GA_segm_leng","ID","moreCtl")$ROC_properties$Feature))
```
...
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "GA_BtwDist","ID","moreCtl")$ROC_curve,Comp_ROC(ds_Q, "group", "GA_BtwDist","ID","moreCtl")$ROC_properties$Feature))
```
...
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "GA_areaPoly","ID","moreSyn")$ROC_curve,Comp_ROC(ds_Q, "group", "GA_areaPoly","ID","moreSyn")$ROC_properties$Feature))
```
...
IDEx_simple    = sample(IDList_simple,2)
IDEx_NOTsimple = sample(IDList_NOTsimple,2)
...
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "GA_isSimple","ID","moreSyn")$ROC_curve,Comp_ROC(ds_Q, "group", "GA_isSimple","ID","moreSyn")$ROC_properties$Feature))
```
...
ExValid <- IDList_isValid # sample(IDList_isValid,5)
ds_poly %>% 
...
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "GA_isValidStruct","ID","moreSyn")$ROC_curve,Comp_ROC(ds_Q, "group", "GA_isValidStruct","ID","moreSyn")$ROC_properties$Feature))
...
⁠dim is the dimension of the intersection (∩) of the interior (I),
boundary (B), and exterior (E) of geometries a and b.
...
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "Sum_relateReciepe","ID","moreSyn")$ROC_curve,Comp_ROC(ds_Q, "group", "Sum_relateReciepe","ID","moreSyn")$ROC_properties$Feature))
...
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "Sum_isClockwise","ID","moreSyn")$ROC_curve,Comp_ROC(ds_Q, "group", "Sum_isClockwise","ID","moreSyn")$ROC_properties$Feature))
...
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "GA_area_convhull","ID","moreSyn")$ROC_curve,Comp_ROC(ds_Q, "group", "GA_area_convhull","ID","moreSyn")$ROC_properties$Feature))
...
knitr::kable(All_ROC_round[order(All_ROC_round$AUC, decreasing = TRUE), ])
```
...
ggroc(list(ROC_curves[[1]],ROC_curves[[3]],ROC_curves[[5]],ROC_curves[[7]],ROC_curves[[9]],ROC_curves[[11]],ROC_curves[[13]],ROC_curves[[15]],ROC_curves[[17]],ROC_curves[[19]],ROC_curves[[21]])) +
  scale_color_manual(labels = c(ROC_curves[[2]],ROC_curves[[4]],ROC_curves[[6]],ROC_curves[[8]],ROC_curves[[10]],ROC_curves[[12]],ROC_curves[[14]],ROC_curves[[16]],ROC_curves[[18]],ROC_curves[[20]],ROC_curves[[22]]), values = brewer.pal(11,name = "Set3")) + theme_minimal()
...
# formula_here <- group ~ SelfInter_persegm * Consistency_zs *GA_segm_leng
# data_here <- ds_Q
# 
