...
across repetitions have led to equivalent AUC for permuted topological
validity and standardized perimeter between repetitions. While the very
best fitting criteria was extracted from a General Linear Model
combining topological validity and perimeter.
...
rise to a synesthetic response in a synthets or whether it is from a
...
## Appendix 1 Sub-sambled data by questionnaire quantiles (10% steps) {#sec-sm1}
