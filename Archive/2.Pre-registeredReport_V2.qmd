...
# Important. To reproduce Rothen, the X = -1 and Y = -1 need to be NaN. So they are ignored.
...
|----|----|----|----|----|----|----|----|----|----|----|
| Rothen | Area | 1.57 | 0.76 | 1'079 | 7'031 | 1365 | 11'149 | 88 | 70 | 1'596 |
| Repro |  |  | 0.75 | **1'312** | 7'031 | **1829** | 11'303 | **85** | 70 | 1'575 |
| Repro_Na |  |  | 0.76 | 930 | 7'031 | 745 | 11'303 | 90 | 70 | 1'574 |
...
ROC_curves <- list(Comp_ROC(ds_Q, "group", "SD_ID_ysc","ID","moreSyn")$ROC_curve,Comp_ROC(ds_Q, "group", "SD_ID_ysc","ID","moreSyn")$ROC_properties$Feature)
...
ROC_curves <- c(ROC_curves,list(Comp_ROC(ds_Q, "group", "SumID_lineInter","ID","moreCtl")$ROC_curve,Comp_ROC(ds_Q, "group", "SumID_lineInter","ID","moreCtl")$ROC_properties$Feature))
```
