...
The average values for each features are reported in @tbl-mytb01. For
the area between repetitions, we find different areas for synesthetes
than in previous results: 0.26% , compared to 0.14% in [-@rothen2016]
and 0.15 % in [@ward2018]). Note that this difference seems to be mainly
driven by the dataset from [@ward] with respectively 0.26% area.
Descriptively, this might be explained by a more variable sample [SD of
0.50 in [-@ward] compared to 0.09 % in @rothen2016\] see @tbl-mytb4.
